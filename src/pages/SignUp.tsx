...
import { Eye, EyeOff, Lock, Mail, User, Fingerprint, ScanFace, CheckCircle2 } from 'lucide-react';
            ...
            <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-100 dark:border-slate-800">
                <div className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Crie sua conta</h1>
                        <p className="text-slate-500 dark:text-slate-400">Junte-se a nós para gerenciar suas finanças</p>
                    </div>
                    ...
                    <div className="mt-8">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-white dark:bg-slate-900 text-slate-500">Ou cadastre com</span>
                            </div>
                        </div>
